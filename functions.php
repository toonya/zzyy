...
function load_custom_wp_admin_style() {
        wp_register_style( 'custom_wp_admin_css', get_template_directory_uri() . '/functions/css/admin.css', false, '1.0.0' );
        
        wp_enqueue_style( 'custom_wp_admin_css' );
        
        wp_enqueue_script( 'custom_wp_admin_css', get_template_directory_uri() . '/functions/js/fn.js', array(), '1.0.0', true );
}
